...
export default function Home() {
  return (
    <>
      ...
      <div>
        <div class="notice">Please remember that iOS devices/Safari users may have issues, we are looking to this problem and will fix it soon 👍</div>
        <div id="jj-head">
        </div>
        <div class="hero min-h-screen bg-none z-10">
          <div class="hero-content text-center">
            <div class="max-w-md">
              <h3 class="text-3xl font-bold comic-block">This is</h3>{" "}
              <br class="sr-only" />
      ...
      <div>
        <br class="sr-only" />
        <div class="z-20 p-3">
          <h1 class="text-7xl comic-block font-black">
          ...
          <div class="grid sm:grid-cols-2 grid-cols-1 sm:grid-rows-1 ">
            <div class="text-end flex sm:justify-start">
              <img
                ...
                alt="A photo of Jill Jimmy standing on a rock in the beach. He is wearing a white top with the letters J J on it and has a silver and blue artificial leg."
              />
            </div>
      ...
      <div class="w-full p-3 bg-white mt-32 md:mt-96">
        ...
        <p class="text-xl">
          There it is, in all of its glory. So what does the CoD actually
          do?<br />Well, it's kinda like a super-duper energy source{" "}
          <span class="mona font-cond font-bold">to the power of 5000.</span>
          <br />It gives you the power of strength, intelligence and speed (the
          Super-Combo™) - all in one package, and its power comes from an
      ...
      <div class="purple-hero">
        <div class="hero-content purple-hero-content text-center">
          <div>
            <h1 class="text-6xl mona purple-hero-content font-black w-full">
              But, of course - any superhero would need a good team, right?
            </h1>
            <br />
            <p class="text-xl purple-hero-content">Meet the crew.</p>
            <br />
            <br />
          </div>
        </div>
      ...
      <div class="wavy bg-black min-h-screen text-primary -my-10 p-6 pt-16 pb-16">
        <div class="w-full glow min-h-full grid grid-rows-2 grid-cols-1 md:grid-rows-1 gap-2 md:grid-cols-2 ">
          <div class="terminal-frame card border-2 border-primary min-h-full">
            <figure>
              <img src="moBot.svg" class="w-96 p-3 glow" alt="A computer named moBot with a terminal open and a smiley face. He has rocket thrusters." />
            </figure>
            <div class="card-body">
              <h2 class="text-6xl card-title mona font-black">moBot</h2>
              <p class="text-lg">
                moBot is Jill Jimmy's computer assistant. With a full shell and
                100% coolness capacity, he can do just about anything.
              </p>
            </div>
          </div>
          <div class="terminal-frame card border-2 border-primary min-h-full">
            ...
            <div class="card-body">
              <h2 class="text-6xl card-title mona font-black">Bagel</h2>
              <p class="text-lg">
                Bagel is JJ's trusty worm. He's really cool and is absolutely PSYCHED about being <b>the</b> assistant.
              </p>
            </div>
            <figure>
              <div class="artboard artboard-horizontal phone-2 text-center" alt="">We're... still working on a pic for this one. <span class="text-opacity-50">Sorry.</span></div>
            </figure>
          </div>
        </div>
      </div>
      <br />
      <div class="p-7">
        <h1 class="text-6xl mona font-black">More JJ stuff coming soon!</h1>
        <br />
        <br />
      </div>
      ...
      <footer class="footer p-10 bg-base-200 text-base-content">
        ...
        <nav class="grid-flow-col gap-4 z-10 md:place-self-center md:justify-self-end">
          <a class="align-middle md:visible invisible text-end">
            This website is a work in progress.<br />Please bear with us, we're
            doing all of the coding ✨🐻‍❄️
          </a>
          <a>
            <a
              class="btn btn-ghost btn-circle"
              href="https://github.com/JillJimmy"
              alt="View our GitHub profile"
            >
              <img
                height="32"
                width="32"
            ...
            <a
              class="btn btn-primary mona"
              href="https://github.com/JillJimmy/web"
            >
              View source
            </a>
            <a class="block align-middle">
              <img src="/iduck-mini.svg" class="h-10" />
            </a>
            <a>
              <svg
